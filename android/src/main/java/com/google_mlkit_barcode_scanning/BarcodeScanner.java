...
public class BarcodeScanner implements MethodChannel.MethodCallHandler {
    ...
    void zoomCallback(float zoomRatio){
        channel.invokeMethod("setZoom", zoomRatio);
    }
    ...
    private com.google.mlkit.vision.barcode.BarcodeScanner initialize(MethodCall call) {
        ...
        if (formatList.size() > 1) {
            ...
            barcodeScannerOptions = new BarcodeScannerOptions.Builder().setBarcodeFormats(formatList.get(0), array).setZoomSuggestionOptions(
